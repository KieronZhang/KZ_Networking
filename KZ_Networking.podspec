...
Pod::Spec.new do |s|
    ...
    s.ios.frameworks = 'Foundation', 'MobileCoreServices', 'CoreGraphics', 'Security', 'SystemConfiguration', 'CoreTelephony'
    s.osx.frameworks = 'Foundation', 'CoreServices', 'Security', 'SystemConfiguration'
